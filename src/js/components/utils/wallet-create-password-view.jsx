...
const WalletCreatePasswordView = (props) => {
    ...
    let infoLabel = 'create a strong password and save it in a safe place. if you lose or forget your password you will lose your funds.';
    if (props.processName === 'import') {
        infoLabel = 'enter the password. if you do not know the password to unlock the wallet you have lost access to your funds.';
    }
