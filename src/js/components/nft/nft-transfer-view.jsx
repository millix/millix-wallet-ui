                ...
                <Row>
                    <Col md={12}>
                        <div className={'panel panel-filled'}>
                            <div className={'panel-heading bordered'}>transfer</div>
                            <div className={'panel-body'}>
                                <p>
                                    you can transfer an encrypted nft to other recipient. the nft will be stored on your device and the recipients
