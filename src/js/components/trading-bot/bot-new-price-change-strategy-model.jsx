...
export default class BotNewPriceChangeStrategyModel extends Component {
    ...
    async save() {
        ...
        data.strategy_change_percentage = validate.integerPositive(`change percentage`, this.strategy_change_percentage.value, error_list, false);
